...
export default function ContactsMap({ adress = {} }) {
    ...
    useEffect(() => {
        ...
        const scrollHandler = event => {
            ...
            console.log(event.scroll.y - refStartPos.current);
    ...
    return (
        <section ref={refSection} id='map' style={{ height: `calc(100vh + 800px)` }} data-scroll-section>
            <div className={style.container}>
                <div data-scroll data-scroll-sticky data-scroll-target='#map' className='col col--30 pt-1'>
                    ...
                    <div className='text--t2 pb-0.5'>{adress.house}</div>
