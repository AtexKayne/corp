...
export default function RangeLine() {
    ...
    const translateB = useTransform(x, [50, 190], [50, 0])
            ...
            <motion.div
                ...
                <div className={style.iconStart}>
                    <motion.div style={{ scale: scaleA, y: translateA }}>
                        <Image src='/assets/img/ripple.svg' width='94' height='94' alt='' />
                    </motion.div>
                </div>
                <div className={style.iconEnd}>
                    <motion.div style={{ scale: scaleB, y: translateB }}>
                        <Image src='/assets/img/boutle.svg' width='94' height='94' alt='' />
                    </motion.div>
                </div>
            </motion.div>
