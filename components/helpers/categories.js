export const _filters = {
    ...
    vid: [
        ...
        { value: 'Вид 3', isSelected: false },
        { value: 'Вид 4', isSelected: false },
        { value: 'Вид 5', isSelected: false, isDisabled: true, },
    ],
    cats: [
...
export const filters = [
    { id: 0,  filterType: 'categoryList', code: "category", name: "Категории", values: [..._filters.cats] },
    { id: 1,  filterType: 'priceRange',   code: "price", name: "Цена", values: [450, 10000] },
    { id: 2,  filterType: 'checkboxList', code: "brand", name: "Бренд", values: [..._filters.brands] },
    { id: 3,  filterType: 'checkboxList', code: "vid", name: "Вид товара", values: [..._filters.vid] },
    { id: 4,  filterType: 'checkboxList', code: "proizvodstvo", name: "Производство", isDisabled: true, values: [..._filters.proizvodstvo] },
    { id: 5,  filterType: 'checkboxList', code: "ves", name: "Вес", values: [..._filters.ves] },
    { id: 6,  filterType: 'checkboxList', code: "pitanie", name: "Питание", values: [..._filters.pitanie] },
    { id: 7,  filterType: 'checkboxList', code: "colors", name: "Цвет", values: [..._filters.colors] },
    { id: 8,  filterType: 'checkboxItem', code: 'market', name: 'Новинки' },
    { id: 9,  filterType: 'checkboxItem', code: 'hits', name: 'Хиты' },
    { id: 10, filterType: 'checkboxItem', code: 'discont', isDisabled: true, name: 'Со скидкой' },
    { id: 11, filterType: 'checkboxItem', code: 'delivery', name: 'Быстрая доставка' },
]
...
export const fastFilters = [
    ...
    {
        name: 'Быстрый фильтр 2', settings: [
            { code: 'brand', values: ['ANDIS 1', 'BEARDBURYS 1'] },
            { code: 'ves', values: ['170 г'] },
            { code: 'pitanie', values: ['Проводные', 'Комбинированные'] },
        ]
    },
    {
