...
export const colors = {
    ...
    tone: [
        {title: '/45', hsl: '350,67%,41%'},
        {title: '/444', hsl: '357,75%,47%'},
        {title: '/44', hsl: '359,74%,49%'},
        {title: '/4', hsl: '358,75%,48%'},
        {title: '/443', hsl: '2,75%,50%'},
        {title: '/43', hsl: '3,76%,51%'},
        {title: '/344', hsl: '15,80%,51%'},
        {title: '/34', hsl: '22,83%,51%'},
        {title: '/28', hsl: '162,99%,28%'},
        {title: '/19', hsl: '196,99%,39%'},
        {title: '/1', hsl: '201,99%,43%'},
        {title: '/18', hsl: '208,81%,39%'},
        {title: '/91', hsl: '214,72%,37%'},
        {title: '/16', hsl: '223,60%,35%'},
        // {title: '/16', hsl: '223,60%,35%'},
        // {title: '/18', hsl: '05555'},
        // {title: '/18', hsl: '05555'},
        // {title: '/18', hsl: '05555'},
