    ...
    return (
        <motion.div className='preloader' 
            ...
            <motion.div className='preloader__container' initial={{rotate: 30 }} animate={{rotate: [30, 120, 80], transition: {duration: 4}}}>
                ...
                <motion.div className='preloader__line' initial={{width: 0, rotate: 135}} animate={{width: '50vw', rotate: 135, transition: {delay: 0.6, duration: 2}}}/>
                <motion.div className='preloader__line' initial={{width: 0, rotate: 180}} animate={{width: '50vw', rotate: 180, transition: {delay: 0.9, duration: 2}}}/>
                <motion.div className='preloader__line' initial={{width: 0, rotate: 225}} animate={{width: '50vw', rotate: 225, transition: {delay: 0.1, duration: 2}}}/>
                <motion.div className='preloader__line' initial={{width: 0, rotate: 270}} animate={{width: '50vw', rotate: 270, transition: {delay: 0.3, duration: 2}}}/>
                <motion.div className='preloader__line' initial={{width: 0, rotate: 315}} animate={{width: '50vw', rotate: 315, transition: {delay: 0.6, duration: 2}}}/>
                <motion.div className='preloader__line' initial={{width: 0, rotate: 360}} animate={{width: '50vw', rotate: 360, transition: {delay: 0.9, duration: 2}}}/>
            </motion.div>
