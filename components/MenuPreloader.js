        ...
        <div className='menu-preloader'>
            <svg width='829' height='829' viewBox='0 0 829 829' fill='none' xmlns='http://www.w3.org/2000/svg'>
                ...
                <motion.path 
                    ...
                    d='M414.517 150.726V314.071' stroke='#8712FC' strokeWidth='3'/>
                <motion.path 
                    initial={{pathLength: 0}} animate={animation}
                    variants={{
                        false: { pathLength: 0, transition: {duration: 0.5, delay: 0} },
                    ...
                    d='M414.495 678.284L414.495 514.939' stroke='#8712FC' strokeWidth='3'/>
                <motion.path 
                    initial={{pathLength: 0}} animate={animation}
                    variants={{
                        false: { pathLength: 0, transition: {duration: 0.5, delay: 0} },
                    ...
                    d='M282.625 186.06L364.297 327.521' stroke='#8712FC' strokeWidth='3'/>
                <motion.path 
                    initial={{pathLength: 0}} animate={animation}
                    variants={{
                        false: { pathLength: 0, transition: {duration: 0.5, delay: 0} },
                    ...
                    d='M546.386 642.949L464.713 501.489' stroke='#8712FC' strokeWidth='3'/>
                <motion.path 
                    initial={{pathLength: 0}} animate={animation}
                    variants={{
                        false: { pathLength: 0, transition: {duration: 0.5, delay: 0} },
                    ...
                    d='M186.072 282.606L327.533 364.279' stroke='#8712FC' strokeWidth='3'/>
                <motion.path 
                    initial={{pathLength: 0}} animate={animation}
                    variants={{
                        false: { pathLength: 0, transition: {duration: 0.5, delay: 0} },
                    ...
                    d='M642.939 546.404L501.479 464.731' stroke='#8712FC' strokeWidth='3'/>
                <motion.path 
                    initial={{pathLength: 0}} animate={animation}
                    variants={{
                        false: { pathLength: 0, transition: {duration: 0.5, delay: 0} },
                    ...
                    d='M150.727 414.494L314.071 414.494' stroke='#8712FC' strokeWidth='3'/>
                <motion.path 
                    initial={{pathLength: 0}} animate={animation}
                    variants={{
                        false: { pathLength: 0, transition: {duration: 0.5, delay: 0} },
                    ...
                    d='M678.285 414.516L514.94 414.516' stroke='#8712FC' strokeWidth='3'/>
                <motion.path 
                    initial={{pathLength: 0}} animate={animation}
                    variants={{
                        false: { pathLength: 0, transition: {duration: 0.5, delay: 0} },
                ...
                <motion.path 
                    ...
                    d='M186.061 546.386L327.522 464.714' stroke='#8712FC' strokeWidth='3'/>
                <motion.path 
                    initial={{pathLength: 0}} animate={animation}
                    variants={{
                        false: { pathLength: 0, transition: {duration: 0.5, delay: 0} },
                    ...
                    d='M642.95 282.625L501.489 364.298' stroke='#8712FC' strokeWidth='3'/>
                <motion.path 
                    initial={{pathLength: 0}} animate={animation}
                    variants={{
                        false: { pathLength: 0, transition: {duration: 0.5, delay: 0} },
                    ...
                    d='M282.607 642.94L364.28 501.479' stroke='#8712FC' strokeWidth='3'/>
                <motion.path 
                    initial={{pathLength: 0}} animate={animation}
                    variants={{
                        false: { pathLength: 0, transition: {duration: 0.5, delay: 0} },
                    ...
                    d='M546.405 186.072L464.732 327.533' stroke='#8712FC' strokeWidth='3'/>
                <motion.path 
                    initial={{pathLength: 0}} animate={animation}
                    variants={{
                        false: { pathLength: 0, transition: {duration: 0.5, delay: 0} },
                    ...
                    d='M294.341 34.2744L328.457 25.1331L319.315 59.2489L294.341 34.2744Z' stroke='#DADFEA' strokeWidth='3'/>
                <motion.path 
                    initial={{pathLength: 0}} animate={animation}
                    variants={{
                        false: { pathLength: 0, transition: {duration: 0.5, delay: 0} },
                    ...
                    d='M534.67 794.736L500.555 803.877L509.696 769.761L534.67 794.736Z' stroke='#DADFEA' strokeWidth='3'/>
                <motion.path 
                    initial={{pathLength: 0}} animate={animation}
                    variants={{
                        false: { pathLength: 0, transition: {duration: 0.5, delay: 0} },
                    ...
                    d='M120.324 145.298L145.299 120.323L154.44 154.439L120.324 145.298Z' stroke='#DADFEA' strokeWidth='3'/>
                <motion.path 
                    initial={{pathLength: 0}} animate={animation}
                    variants={{
                        false: { pathLength: 0, transition: {duration: 0.5, delay: 0} },
                    ...
                    d='M708.687 683.712L683.712 708.686L674.571 674.57L708.687 683.712Z' stroke='#DADFEA' strokeWidth='3'/>
                <motion.path 
                    initial={{pathLength: 0}} animate={animation}
                    variants={{
                        false: { pathLength: 0, transition: {duration: 0.5, delay: 0} },
                    ...
                    d='M25.1335 328.455L34.2748 294.34L59.2493 319.314L25.1335 328.455Z' stroke='#DADFEA' strokeWidth='3'/>
                <motion.path 
                    initial={{pathLength: 0}} animate={animation}
                    variants={{
                        false: { pathLength: 0, transition: {duration: 0.5, delay: 0} },
                    ...
                    d='M803.877 500.554L794.736 534.67L769.761 509.696L803.877 500.554Z' stroke='#DADFEA' strokeWidth='3'/>
                <motion.path 
                    initial={{pathLength: 0}} animate={animation}
                    variants={{
                        false: { pathLength: 0, transition: {duration: 0.5, delay: 0} },
                    ...
                    d='M34.2746 534.67L25.1333 500.554L59.2491 509.695L34.2746 534.67Z' stroke='#DADFEA' strokeWidth='3'/>
                <motion.path 
                    initial={{pathLength: 0}} animate={animation}
                    variants={{
                        false: { pathLength: 0, transition: {duration: 0.5, delay: 0} },
                    ...
                    d='M794.736 294.34L803.877 328.456L769.762 319.315L794.736 294.34Z' stroke='#DADFEA' strokeWidth='3'/>
                <motion.path 
                    initial={{pathLength: 0}} animate={animation}
                    variants={{
                        false: { pathLength: 0, transition: {duration: 0.5, delay: 0} },
                    ...
                    d='M145.299 708.686L120.324 683.711L154.44 674.57L145.299 708.686Z' stroke='#DADFEA' strokeWidth='3'/>
                <motion.path 
                    initial={{pathLength: 0}} animate={animation}
                    variants={{
                        false: { pathLength: 0, transition: {duration: 0.5, delay: 0} },
                    ...
                    d='M683.712 120.324L708.687 145.298L674.571 154.439L683.712 120.324Z' stroke='#DADFEA' strokeWidth='3'/>
                <motion.path 
                    initial={{pathLength: 0}} animate={animation}
                    variants={{
                        false: { pathLength: 0, transition: {duration: 0.5, delay: 0} },
                    ...
                    d='M328.456 803.877L294.34 794.736L319.315 769.761L328.456 803.877Z' stroke='#DADFEA' strokeWidth='3'/>
                <motion.path 
                    initial={{pathLength: 0}} animate={animation}
                    variants={{
                        false: { pathLength: 0, transition: {duration: 0.5, delay: 0} },
                    ...
                    d='M500.555 25.133L534.671 34.2743L509.696 59.2488L500.555 25.133Z' stroke='#DADFEA' strokeWidth='3'/>
            </svg>
        </div>
    );
}
