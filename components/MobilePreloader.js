...
export default function MobilePreloader({ animatePreloader, setPreloaderState }) {
        ...
        <motion.div
            ...
            <motion.div
                ...
                <motion.div initial={{ rotate: 30 }} animate={{ rotate: [30, 120, 60], transition: { duration: 5 } }}>
                    <motion.div className='preloader__line' initial={{ width: '0vh', rotate: 45 }}  animate={{ width: ['0vh', '60vh', '60vh', '60vh', '0vh'], rotate: 45,  transition: { delay: 0.1, duration: 4 } }} />
                    <motion.div className='preloader__line' initial={{ width: '0vh', rotate: 90 }}  animate={{ width: ['0vh', '60vh', '60vh', '60vh', '0vh'], rotate: 90,  transition: { delay: 0.3, duration: 4 } }} />
                    <motion.div className='preloader__line' initial={{ width: '0vh', rotate: 135 }} animate={{ width: ['0vh', '60vh', '60vh', '60vh', '0vh'], rotate: 135, transition: { delay: 0.6, duration: 4 } }} />
                    <motion.div className='preloader__line' initial={{ width: '0vh', rotate: 180 }} animate={{ width: ['0vh', '60vh', '60vh', '60vh', '0vh'], rotate: 180, transition: { delay: 0.9, duration: 4 } }} />
                    <motion.div className='preloader__line' initial={{ width: '0vh', rotate: 225 }} animate={{ width: ['0vh', '60vh', '60vh', '60vh', '0vh'], rotate: 225, transition: { delay: 0.1, duration: 4 } }} />
                    <motion.div className='preloader__line' initial={{ width: '0vh', rotate: 270 }} animate={{ width: ['0vh', '60vh', '60vh', '60vh', '0vh'], rotate: 270, transition: { delay: 0.3, duration: 4 } }} />
                    <motion.div className='preloader__line' initial={{ width: '0vh', rotate: 315 }} animate={{ width: ['0vh', '60vh', '60vh', '60vh', '0vh'], rotate: 315, transition: { delay: 0.6, duration: 4 } }} />
                    <motion.div className='preloader__line' initial={{ width: '0vh', rotate: 360 }} animate={{ width: ['0vh', '60vh', '60vh', '60vh', '0vh'], rotate: 360, transition: { delay: 0.9, duration: 4 } }} />
                </motion.div>
                ...
                <svg width='100%' height='100%' viewBox='0 0 829 829' fill='none'>
