    ...
    return (
        <div className='search'>
            <div className='search__results pt-1'>
                ...
                <a href='mail:info@simrussia.ru' className='search__item search__item--single c-hover my-2.5 my-1:md'>
                ...
                <A text='Все контакты' href='/contacts' externalClass='mt-2 mt-0.5:md text--t2 link link--underline'/>
            </div>
        </div>
    )
}